...
[How To Ask Questions The Smart Way](http://www.catb.org/esr/faqs/smart-questions.html) может
быть полезен для людей, у которых часто возникают трудности при попытке задать
вопрос на техническую тему.
